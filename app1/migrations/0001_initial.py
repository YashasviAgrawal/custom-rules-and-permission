    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('admin', 'admin'), ('staff', 'staff'), ('doctor', 'doctor'), ('patient', 'patient')], default='patient', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('appointment_number', models.CharField(default=app1.models.generate_number, max_length=100, unique=True)),
                ('doctor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='appointments', to='app1.doctorprofile')),
                ('patient', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='appointments', to='app1.patientprofile')),
            ],
        ),
        migrations.CreateModel(
            name='StaffProfile',
            fields=[
                ...
                ('doctor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='staff', to='app1.doctorprofile')),
